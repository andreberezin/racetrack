...
function RaceCountdown() {
    ...
    // todo backend server crashed when timer reaches 0
    //  [1] 1:57:07 PM [vite] ws proxy error:
    // [1] AggregateError [ECONNREFUSED]:
    // [1]     at internalConnectMultiple (node:net:1118:18)
    // [1]     at afterConnectMultiple (node:net:1685:7)
